...
import (
	...
	"github.com/ruvcoindev/ruvmail/internal/smtpserver"
	"github.com/ruvcoindev/ruvmail/internal/storage/sqlite3"
	"github.com/ruvcoindev/ruvmail/internal/transport"
...
func main() {
	...
	transport, err := transport.NewRuvchainTransport(rawlog, sk, pk, peerAddrs, *multicast)
	if err != nil {
		panic(err)
	}
